...
Fun = [x(1) + x(2) - x(3);                              % mass TVC
       ...
       - x(12)*x(13) - x(14)*x(16);                     % energy 1st effect
       TV0 - x(10) - dTi(1) - BPE - dTfric;                 % LMTD 1st effect
       ...
       x(16) - FuncHsw(x(10)+BPE,x(15))];                   % enthalpy correlation HW1
  ...
  if n > 1
      ...
      for i = 2:n
          ...
          iFun = [x(8*(i-2)+9) + x(8*(i-2)+12) - x(8*(i-1)+12);                 % mass ist effect (shell side)
                  ...
                  x(8*(i-2)+9)*x(8*(i-2)+11) + x(8*(i-2)+12)*x(8*(i-2)+13) ...
                  + x(8*(i-2)+14)*x(8*(i-2)+16) - x(8*(i-1)+9)*x(8*(i-1)+11) ...
                  - x(8*(i-1)+12)*x(8*(i-1)+13) - x(8*(i-1)+14)*x(8*(i-1)+16);  % energy ist effect
                  x(8*(i-2)+10) - x(8*(i-1)+10) - dTi(i) - BPE - dTfric;            % LMTD ist effect
                  x(8*(i-1)+11) - FuncHsatv(8*(i-1)+10);                        % enthalpy correlation HVi
                  x(8*(i-1)+13) - FuncHsw(x(8*(i-2)+10),0);                     % enthalpy correlation HDi
                  x(8*(i-1)+16) - FuncHsw(x(8*(i-1)+10)+BPE,x(8*(i-1)+15))];        % enthalpy correlation HWi
              Fun = [Fun; iFun];
      end
